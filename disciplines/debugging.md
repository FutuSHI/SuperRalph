...
4. **Trace data flow.** Where does the bad value originate? What called this with the bad value? Keep tracing upstream until you find the source. Fix at the source, not at the symptom. (See `disciplines/root-cause-tracing.md` for the full backward-tracing technique.)
